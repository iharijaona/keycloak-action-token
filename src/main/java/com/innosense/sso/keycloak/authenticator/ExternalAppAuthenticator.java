...
import com.innosense.sso.keycloak.actiontoken.ExternalAppActionToken;
import com.innosense.sso.keycloak.actiontoken.ExternalAppTokenHandler;
import static com.innosense.sso.keycloak.actiontoken.ExternalAppTokenHandler.QUERY_PARAM_APP_TOKEN;
...
public class ExternalAppAuthenticator implements Authenticator {
    ...
    public void authenticate(AuthenticationFlowContext context) {
        ...
        String submitActionTokenUrl = Urls
          ...
          .queryParam(ExternalAppTokenHandler.QUERY_PARAM_APP_TOKEN, "{tokenParameterName}")
    ...
    public void action(AuthenticationFlowContext context) {
        final AuthenticationSessionModel authSession = context.getAuthenticationSession();
        if (! Objects.equals(authSession.getAuthNote(ExternalAppTokenHandler.INITIATED_BY_ACTION_TOKEN_EXT_APP), "true")) {
            authenticate(context);
            return;
        }

        authSession.removeAuthNote(ExternalAppTokenHandler.INITIATED_BY_ACTION_TOKEN_EXT_APP);
        ...
        logger.error("appTokenString => " + appTokenString);
